...
- **Revision 2026-09-25:** An opened list is sectioned by status (In progress, Planned, Ideas, Completed) with an Organize control beside Options for category or priority, remembered per device. Ideas are tiles with a category mark, a four-dot priority meter and lived dates, and pages append through Load more ideas. Edit idea and Delete idea share the detail page's foot row; every deletion, list included, opens the shared confirmation dialog.
