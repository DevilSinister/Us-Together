...
export function MemoryForm({sourcePlan,memory,previewSession,defaultDate}:{previewSession?:string;sourcePlan?:{id:string;title:string;memoryDate:string;location:string|null};memory?:Memory;defaultDate?:string}) {
